...
% MSE calculation
MSE_LS_over_Doppler(DopplerShift == doppler, 1) = sum(LS_MSE_in_frame, 1) / Num_of_frame_each_SNR;

MSE_MMSE_over_Doppler(DopplerShift == doppler, 1) = sum(MMSE_MSE_in_frame, 1) / Num_of_frame_each_SNR;

MSE_DNN_over_Doppler(DopplerShift == doppler, 1) = sum(DNN_MSE_in_frame, 1) / Num_of_frame_each_SNR;

MSE_ResNet_over_Doppler(DopplerShift == doppler, 1) = sum(ResNet_MSE_in_frame, 1) / Num_of_frame_each_SNR;

MSE_Transformer_over_Doppler(DopplerShift == doppler, 1) = sum(Transformer_MSE_in_frame, 1) / Num_of_frame_each_SNR;

MSE_Hybrid_over_Doppler(DopplerShift == doppler, 1) = sum(Hybrid_MSE_in_frame, 1) / Num_of_frame_each_SNR;
